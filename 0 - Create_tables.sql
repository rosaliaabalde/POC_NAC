...
-- MAGIC CREATE OR REFRESH STREAMING LIVE TABLE F0 (
...
-- MAGIC %scala
-- MAGIC //spark.readStream.format("delta").option("readChangeFeed", "true").table("f1")
...
-- MAGIC %scala
-- MAGIC //spark.readStream.format("delta").option("readChangeFeed", "true").table("f2_cont")

-- COMMAND ----------

-- MAGIC %sql
-- MAGIC CREATE OR REPLACE TABLE ps (
...
-- MAGIC %scala
-- MAGIC //spark.readStream.format("delta").option("readChangeFeed", "true").table("ps")
